...
function vehicle(length, width, u, lane, speed, type) {
  ...
  this.longModel = new ACC(20, 1.3, 2, 1,
  2); //IDM_v0,IDM_T,IDM_s0,IDM_a,IDM_b);
  this.LCModel = new MOBIL(4, 20, 0.1, 0.2,
  0.3); //bSafe, bSafeMax, p, bThr, biasRight)
}
//######################################################################
...
vehicle.prototype.isRegularVeh = function() {
  return (this.isPerturbed() || (this.id >= 200)) && (this.type !==
    "obstacle");
};
