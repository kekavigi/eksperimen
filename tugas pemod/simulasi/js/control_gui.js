...
function handleChangedPriority(index) {
  ...
  console.log('in handleChangedPriority: index=', index, ' respectRingPrio=',
    respectRingPrio, ' respectRightPrio=', respectRightPrio);
}
...
function handleChangedOD(index) {
  ...
  console.log('in handleChangedOD: index=', index, ' leftTurnBias=',
    leftTurnBias, ' focusFrac=', focusFrac);
}
/*#########################################################
 game callbacks
#########################################################
...
function updateRoutingGame(time) {
  qIn = (time < 50) ? 3000 / 3600 : (time < 90) ? 600 / 3600 : (time < 120) ?
    3300 / 3600 : (time < 125) ? 900 / 3600 : 0;
...
function updateHighscores(nickName, newScore, storageName) {
  ...
  var str_highScores = '<h1> Game Finished!</h1> Your time is ' + newScore +
    ' Seconds' + '<h2>Highscore list:</h2>' +
  ...
  for (var i = 0; i < Math.min(scores.length, 10); i++) {
    console.log('name:', scores[i].name, ' score:', scores[i].score, ' date:',
      scores[i].date);
    str_highScores += '<tr>' + '<td>' + (i + 1) + '</td>' + '<td>' + scores[i]
      .name + '</td>' + '<td>' + scores[i].score + '</td>'
      // + '<td>'+scores[i].date+'</td>'
      + '</tr>'
  }
...
function subtractOneLane() {
  if (mainroad.nLanes > nLanesMin) {
    ...
    console.log('subtractOneLane(): minimum of ', nLanesMax, ' lanes reached!');
  }
...
if (document.getElementById('slider_timewarp') == null) console.log(
  'no timewarp slider');
else {
...
if (document.getElementById('slider_scale') === null) console.log(
  'no scale slider');
else {
...
if (document.getElementById('slider_qIn') === null) console.log(
'no qIn slider');
else {
...
if (document.getElementById('slider_qOn') === null) console.log(
'no qOn slider');
else {
...
if (document.getElementById('slider_fracTruck') === null) console.log(
  'no fracTruck slider');
else {
...
if (document.getElementById('slider_density') === null) console.log(
  'no density slider');
else {
...
if (document.getElementById('slider_fracOff') === null) console.log(
  'no fracOff slider');
else {
...
if (document.getElementById('slider_mainFrac') === null) console.log(
  'no mainFrac slider');
else {
...
if (document.getElementById('slider_leftTurnBias') === null) console.log(
  'no leftTurnBias slider');
else {
...
if (document.getElementById('slider_focusFrac') === null) console.log(
  'no focusFrac slider');
else {
...
if (document.getElementById('slider_IDM_v0') === null) console.log(
  'no IDM_v0 slider');
else {
...
if (document.getElementById('slider_IDM_T') === null) console.log(
  'no IDM_T slider');
else {
...
if (document.getElementById('slider_IDM_s0') === null) console.log(
  'no IDM_s0 slider');
else {
...
if (document.getElementById('slider_IDM_a') === null) console.log(
  'no  IDM_a slider');
else {
...
if (document.getElementById('slider_IDM_b') === null) console.log(
  'no  IDM_b slider');
else {
...
if (document.getElementById('slider_speedL') === null) console.log(
  'no  speedL slider');
else {
...
if (document.getElementById('slider_IDM_v0Up') === null) console.log(
  'no  IDM_v0Up slider');
else {
...
if (document.getElementById('slider_MOBIL_bThr') === null) console.log(
  'no  MOBIL_bThr slider');
else {
...
if (document.getElementById('slider_MOBIL_bBiasRight_car') === null) console
  .log('no  MOBIL_bBiasRight_car slider');
else {
  ...
  slider_MOBIL_bBiasRight_car.oninput = function() {
    slider_MOBIL_bBiasRight_carVal.innerHTML = this.value +
    ' m/s<sup>2</sup>';
...
if (document.getElementById('slider_MOBIL_bBiasRight_truck') === null) console
  .log('no  MOBIL_bBiasRight_truck slider');
else {
  ...
  slider_MOBIL_bBiasRight_truck.oninput = function() {
    slider_MOBIL_bBiasRight_truckVal.innerHTML = this.value +
      ' m/s<sup>2</sup>';
...
if (document.getElementById('slider_MOBIL_p') === null) console.log(
  'no  MOBIL_p slider');
else {
...
function updateModels() {
  ...
  LCModelCar = new MOBIL(MOBIL_bSafe, MOBIL_bSafeMax, MOBIL_p, MOBIL_bThr,
    MOBIL_bBiasRight_car);
  LCModelTruck = new MOBIL(MOBIL_bSafe, MOBIL_bSafeMax, MOBIL_p, MOBIL_bThr,
    MOBIL_bBiasRight_truck);
  LCModelMandatory = new MOBIL(MOBIL_mandat_bSafe, MOBIL_mandat_bSafe,
    MOBIL_mandat_p, MOBIL_mandat_bThr, MOBIL_mandat_bias);
  console.log('control_gui.updateModels:', ' longModelTruck.speedlimit=',
    longModelTruck.speedlimit);
}
