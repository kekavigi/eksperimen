...
function mqSmartphone() {
  ...
  return mqMobile() || (window.innerWidth < windowSizeCrit) || (window
    .innerHeight < windowSizeCrit);
}
/*
...
function displayMediaProperties(canvas, textsize) {
  ...
  var ge144dpi = window.matchMedia('min-resolution: 144dpi')
    .matches // although
  var ge192dpi = window.matchMedia('min-resolution: 192dpi')
    .matches // css works
  ...
  var displayStr5 = 'ge96dpi=' + ge96dpi + ' ge144dpi=' + ge144dpi +
    ' ge192dpi=' + ge192dpi;
  var displayStr6 = (mqSmartphone()) ? 'Smartphone' : (mqMobile()) ? 'Tablet' :
    'Desktop';
  ...
  ctx.fillRect(display_xlb, display_ylb - display_height, display_width,
    display_height);
  ctx.fillStyle = 'rgb(0,0,0)';
  ctx.fillText(displayStr1, display_xlb + 0.2 * textsize, display_ylb - 6.2 *
    textsize);
  ctx.fillText(displayStr2, display_xlb + 0.2 * textsize, display_ylb - 5.2 *
    textsize);
  ctx.fillText(displayStr3, display_xlb + 0.2 * textsize, display_ylb - 4.2 *
    textsize);
  ctx.fillText(displayStr4, display_xlb + 0.2 * textsize, display_ylb - 3.2 *
    textsize);
  ctx.fillText(displayStr5, display_xlb + 0.2 * textsize, display_ylb - 2.2 *
    textsize);
  ctx.fillText(displayStr6, display_xlb + 0.2 * textsize, display_ylb - 1.2 *
    textsize);
  ctx.fillText(displayStr7, display_xlb + 0.2 * textsize, display_ylb - 0.2 *
    textsize);
